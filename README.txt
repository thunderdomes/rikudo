...
It's very easy to get started with ApPHP Hotel Site!!!

1. Installation:
   http://apphp.com/php-hotel-site/index.php?page=installation 
   or docs/Installation.htm

2. Getting Started:
   http://apphp.com/php-hotel-site/index.php?page=getting_started
   or docs/GettingStarted.htm

-----------------------------------------------------------------------------------
For more information visit: 
	site 	http://apphp.com/php-hotel-site/index.php?page=examples
