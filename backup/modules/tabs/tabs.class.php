 ...
 class Tabs
 {
	...
	*/
    public function Display($mode="")
    {
       ...
       echo "\n<!-- END This script was generated by tabs.class.php v.".Tabs::tabsVersion."(http://www.apphp.com/php-tabs/index.php) END -->\n";
	...
	*/
    public function Enable($tab)
    {
       ...
       {
          if($this->isDebug)
             echo "<font color='#FF0000'>Error: 'Enable' function parameter is not a valid Tab object</font>";
          return;
       }
	...
	*/
    public function Disable($tab)
    {
       ...
       {
          if($this->isDebug)
             echo "<font color='#FF0000'>Error: 'Disable' function parameter is not a valid Tab object</font>";
          return;
       }
       foreach($this->tabs as $tempTab)
       {
	...
	*/
    public function SetDefaultTab($defaultTab)
    {
        ...
        {
           if($this->isDebug)
              echo "<font color='#FF0000'>Error: 'SetDefaultTab' function parameter is not a valid Tab object</font>";
           return;
        }
...
class Tab
{
	...
	*/
    public function AddTab($caption,$file="",$enabled=true)
    {
        ...
        {
           echo "<font color='#FF0000'>Error: tab ".$this->caption." has no valid parent object</font>";
           return;
        }
        $id=$this->GetId()."_".++$this->numChildren;
