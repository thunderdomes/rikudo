...
<legend class='cal_legend'>{h:lan_category_details}</legend>
<table class='fieldset_content' align='center' border='0' width='430px'>				
<tr valign='top'>
    <td width='45%' align='right'>{h:lan_category_name}:</td>
    <td></td>
...
<tr valign='top'>
    ...
    <td></td>
    <td align='left'><label type='text'>{h:category_description}</label></td>
</tr>
<tr valign='top'>
    <td align='right'>{h:lan_cat_color}</td>
    <td></td>
    <td align='left'>{h:ddl_colors}</td>
</tr>
<tr valign='top'>
