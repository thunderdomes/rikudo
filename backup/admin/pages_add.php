...
if(@$objLogin->IsLoggedInAsAdmin()){
	...
	// draw title bar
	draw_title_bar(prepare_breadcrumbs(array(_PAGE_MANAGEMENT=>"",_PAGE_ADD_NEW=>"")));
	echo $msg;
...
?>
	...
	<script type="text/javascript">
		function Language_OnChange(val){
			document.location.href = "index.php?admin=pages_add&language_id="+val;
		}	
		function Cancel(){
			document.location.href = "index.php?admin=pages";
		}
	</script>
		...
		<tr>
			<td valign="top" style='border:1px solid #dedede'>
				...
				<tr id='link_row_1' style='display:none;'>
					<td><?php echo _LINK;?> (http://)<font color="#c13a3a">*</font>:</td>
					<td><input class="form_text" name="link_url" id="frmPage_link_url" value="<?php echo $objPage->GetParameter("link_url");?>" size="35" maxlength="255" /></td>
				</tr>
				...
				<tr id='row_meta_2' style="display:none;">
					...
					<td>
						<textarea class="form_text" name="tag_title" style="width:470px" rows="1"><?php echo $tag_title; ?></textarea>
					</td>
				</tr>
				<tr id='row_meta_3' style="display:none;">
					<td><?php echo _META_TAG;?> &lt;KEYWORDS&gt;:</td>
					<td>
						<textarea class="form_text" name="tag_keywords" style="width:470px" rows="2"><?php echo $tag_keywords; ?></textarea>
					</td>
				</tr>
				<tr id='row_meta_4' style="display:none;">
					<td><?php echo _META_TAG;?> &lt;DESCRIPTION&gt;:</td>
					<td>
						<textarea class="form_text" name="tag_description" style="width:470px" rows="2"><?php echo $tag_description; ?></textarea>
					</td>
				</tr>
				<tr><td colspan="2" height='10px'></td></tr>
				...
				<tr id='page_row_3' style="display:none;">
					<td colspan="2" nowrap height='98px'></td>
				</tr>
				<tr><td colspan="2" nowrap height='3px'></td></tr>
				<tr>
			...
			<td valign="top" style='width:270px;border:1px solid #dedede'>
				...
				if(Modules::IsModuleInstalled("comments")){
					...
					if($objCommentsSettings->GetSettings("comments_allow") == "yes"){
						echo "<tr><td nowrap>"._ALLOW_COMMENTS.":</td>
						<td nowrap>
	...
	<script type="text/javascript">
		...
		Calendar.setup({firstDay:0, inputField:'finish_publishing', ifFormat:'%Y-%m-%d', showsTime:false, button:'finish_publishing_icon'});		
	</script>	
