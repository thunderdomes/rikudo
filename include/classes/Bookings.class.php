...
class Bookings extends MicroGrid {
	...
	public function DrawBookingInvoice($rid, $text_only = false, $type = 'html', $draw = true)
	{
		...
		if($result[1] > 0){
			...
			//$part .= '<tr><td colspan="2">'<img style="MARGIN-RIGHT: 7px" border="0" alt="" vspace="5" align="left" src="images/uploads/logo1.png"></td></tr>';				      
	      	$part .= '<tr><td width="180"><img src="images/uploads/logo.png" alt="" width="180" height="155" ></td></tr>';
			$part .= '<tr>
					<td valign="top">						
	...
	public function RecalculateExtras($rid, $sel_extras, $extras_amount, $act = 'add')
	{
		...
		if($result[1] > 0){
			...
			//$sql = SELECT SUM(price+guests_fee+meal_plan_price) as order_price FROM ' . TABLE_BOOKINGS_ROOMS . ' WHERE booking_number = \'' . $booking_number . '\'';
