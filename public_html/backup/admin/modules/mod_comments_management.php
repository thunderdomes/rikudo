...
if(@$objLogin->IsLoggedInAsAdmin() && Modules::IsModuleInstalled("comments")){
	...
	// Start main content
	draw_title_bar(prepare_breadcrumbs(array(_MODULES=>"",_COMMENTS_MANAGEMENT=>"",(!empty($page_name)?$page_name:"")=>"",(($action)?ucfirst($action):"")=>"")));
	echo $msg;
