...
if(@$objLogin->IsLoggedInAs('owner','mainadmin')){
    ...
    draw_title_bar(prepare_breadcrumbs(array(_MENU_MANAGEMENT=>"",_MENU_EDIT=>"")));
	echo $msg;
...
?>
	<form name='frmEditMenu' method='post' action="index.php?admin=menus_edit">
		...
		<tr>
			<td><?php echo _MENU_NAME;?> <font color="#c13a3a">*</font>:</td>
			<td><input class="form_text" name="name" value="<?php echo $menu->GetName();?>" size="40" maxlength="20"></td>
		</tr>
		<tr>
			<td><?php echo _MENU_ORDER;?> <font color="#c13a3a">*</font>:</td>
			<td>
				<?php
